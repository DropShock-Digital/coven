...
description: "Форма адаптера harness, которую Coven использует сегодня, требования к новым harness и как Codex и Claude Code ложатся на поверхность адаптера v0."
---
